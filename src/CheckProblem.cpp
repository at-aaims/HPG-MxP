...
template void CheckProblem< SparseMatrix<double>, Vector<double> >(
    SparseMatrix<double>&, Vector<double>*, Vector<double>*, Vector<double>*);

template void CheckProblem< SparseMatrix<float>, Vector<float> >(
    SparseMatrix<float>&, Vector<float>*, Vector<float>*, Vector<float>*);
