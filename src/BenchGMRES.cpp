...
// uniform version
template int BenchGMRES<double, double, double >(int, char**, comm_type, DeviceCtx*, int, bool, bool,
                                                 const HPGMP_gen_opts&, TestGMRESData&);

template int BenchGMRES<float, float, float >(int, char**, comm_type, DeviceCtx*, int, bool, bool,
                                              const HPGMP_gen_opts&, TestGMRESData&);
