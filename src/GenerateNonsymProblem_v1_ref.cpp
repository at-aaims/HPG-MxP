...
#else
    // CONTIGUOUS ARRAYS is ON by default
    // Now allocate the arrays pointed to
...
//#define NONSYMM_NUMERICAL
                                        ...
                                        *currentIndexPointerG++ = curcol;
                                        //HPGMP_fout << currentLocalRow << ", " << curcol << ", " << *(currentValuePointer-1) << "," << std::endl;
...
// uniform
template void GenerateNonsymProblem_v1_ref< SparseMatrix<double>, Vector<double> >(
