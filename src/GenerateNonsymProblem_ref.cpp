...
// uniform
template void GenerateNonsymProblem_ref< SparseMatrix<double>, Vector<double> >(
    SparseMatrix<double>&, Vector<double>*, Vector<double>*, Vector<double>*, bool);

template void GenerateNonsymProblem_ref< SparseMatrix<float>, Vector<float> >(
    SparseMatrix<float>&, Vector<float>*, Vector<float>*, Vector<float>*, bool);


// mixed
template void GenerateNonsymProblem_ref< SparseMatrix<float>, Vector<double> >(
    SparseMatrix<float>&, Vector<double>*, Vector<double>*, Vector<double>*, bool);
