...
/*!
 ...
 HPGMP data structures for YAML output
 */
...
//! HPGMP YAML_Element class, from the HPGMP YAML_Element class for registering key-value pairs of performance data

/*!
  HPGMP generates a collection of performance data for each run of the executable.  YAML_Element, and
